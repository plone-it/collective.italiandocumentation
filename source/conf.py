...
html_title = "La documentazione Italiana di Plone"
...
htmlhelp_basename = 'italiandocumentation'
...
latex_documents = [
  ('index', 'ItalianPloneDocumentation.tex', u'La guida completa alla Zope Component Architecture',
   u'Baiju M e la comunità Plone Italia', 'manual'),
]
